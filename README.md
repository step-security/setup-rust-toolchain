...
The action is heavily inspired by _dtolnay_'s <https://github.com/step-security/dtolnay-rust-toolchain> and extends it with further features.
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: step-security/setup-rust-toolchain@v1
...
| `cache-workspaces`       | Propagates the value to [`step-security/rust-cache`]. Influenced by the value of `rust-src-dir`.                                                                                        |               |
| `cache-on-failure`       | Propagates the value to [`step-security/rust-cache`]                                                                                                                                    | true          |
| `cache-key`              | Propagates the value to [`step-security/rust-cache`] as `key`                                                                                                                           |               |
| `cache-shared-key`       | Propagates the value to [`step-security/rust-cache`] as `shared-key`                                                                                                                    |               |
| `cache-bin`              | Propagates the value to [`step-security/rust-cache`] as `cache-bin`                                                                                                                     | true          |
| `cache-provider`         | Propagates the value to [`step-security/rust-cache`] as `cache-provider`                                                                                                                | 'github'      |
...
[`step-security/rust-cache`]: https://github.com/step-security/rust-cache
